...
# idle 上に掛けるオイラー差分（両腕は外側 Y 符号を維持して頭の横へ）
CROUCH_DELTA = {
    "pelvis": (0.35, 0.0, 0.0),
    "thigh.l": (1.35, 0.08, -0.12),
    "thigh.r": (1.35, -0.08, 0.12),
    "calf.l": (-1.55, 0.0, 0.0),
    "calf.r": (-1.55, 0.0, 0.0),
    "foot.l": (0.35, 0.0, 0.0),
    "foot.r": (0.35, 0.0, 0.0),
    "spine_01": (0.55, 0.0, 0.0),
    "spine_02": (0.65, 0.0, 0.04),
    "neck_01": (0.45, 0.0, -0.06),
    "head": (0.35, 0.0, 0.05),
    "clavicle.r": (0.25, -0.35, 0.2),
    "upperarm.r": (-0.95, -1.05, 0.85),
    "lowerarm.r": (-1.55, 0.35, 0.25),
    "hand.r": (0.35, 0.55, -0.7),
    "clavicle.l": (0.25, 0.35, -0.2),
    "upperarm.l": (-0.95, 1.05, -0.85),
    "lowerarm.l": (-1.55, -0.35, -0.25),
    "hand.l": (0.35, -0.55, 0.7),
}
...
GUARD_DELTA = {
    ...
    "head": (0.12, 0.0, 0.0),
    "clavicle.r": (0.05, -0.08, 0.05),
    "upperarm.r": (0.2, -0.35, 0.2),
    "lowerarm.r": (-0.4, 0.1, 0.05),
    "hand.r": (0.1, 0.15, -0.15),
    "clavicle.l": (0.05, 0.08, -0.05),
    "upperarm.l": (0.2, 0.35, -0.2),
    "lowerarm.l": (-0.4, -0.1, -0.05),
    "hand.l": (0.1, -0.15, 0.15),
}
