...
# idle 上に掛けるオイラー差分（肘を外に上げ、両手で頭を抱える）
CROUCH_DELTA = {
    "pelvis": (0.25, 0.0, 0.0),
    "thigh.l": (1.25, 0.08, -0.1),
    "thigh.r": (1.25, -0.08, 0.1),
    "calf.l": (-1.45, 0.0, 0.0),
    "calf.r": (-1.45, 0.0, 0.0),
    "foot.l": (0.3, 0.0, 0.0),
    "foot.r": (0.3, 0.0, 0.0),
    "spine_01": (0.35, 0.0, 0.0),
    "spine_02": (0.4, 0.0, 0.0),
    "neck_01": (0.3, 0.0, 0.0),
    "head": (0.25, 0.0, 0.0),
    "clavicle.r": (0.4, -0.45, 0.2),
    "upperarm.r": (-1.5, -0.6, 0.1),
    "lowerarm.r": (-2.4, 1.0, 0.0),
    "hand.r": (0.3, 0.45, -0.55),
    "clavicle.l": (0.4, 0.45, -0.2),
    "upperarm.l": (-1.5, 0.6, -0.1),
    "lowerarm.l": (-2.4, -1.0, 0.0),
    "hand.l": (0.3, -0.45, 0.55),
}

# しゃがむ前の軽いつらさ（腕は後ろに回さない）
GUARD_DELTA = {
    "spine_01": (0.12, 0.0, 0.0),
    "spine_02": (0.18, 0.0, 0.0),
    "neck_01": (0.15, 0.0, 0.0),
    "head": (0.12, 0.0, 0.0),
    "clavicle.r": (0.08, -0.12, 0.06),
    "upperarm.r": (-0.25, -0.45, 0.1),
    "lowerarm.r": (-0.55, 0.25, 0.05),
    "hand.r": (0.1, 0.15, -0.2),
    "clavicle.l": (0.08, 0.12, -0.06),
    "upperarm.l": (-0.25, 0.45, -0.1),
    "lowerarm.l": (-0.55, -0.25, -0.05),
    "hand.l": (0.1, -0.15, 0.2),
}
